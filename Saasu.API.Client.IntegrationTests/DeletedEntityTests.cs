...
namespace Saasu.API.Client.IntegrationTests
{
    ...
    public class DeletedEntityTests
    {
        ...
        public void FilterOnEntityTypeSale()
        {
            ...
            Assert.NotNull(result.DataObject, "Error with response object");
            Assert.NotNull(result.DataObject.Entities, "Error with response object entity collection");
            Assert.IsNull(result.DataObject.Entities.SingleOrDefault(e => e.EntityTypeId != 4), "Non-sale entity type in result set");
        }
        ...
        public void FilterOnEntityTypePurchase()
        {
            ...
            Assert.NotNull(result.DataObject, "Error with response object");
            Assert.NotNull(result.DataObject.Entities, "Error with response object entity collection");
            Assert.IsNull(result.DataObject.Entities.SingleOrDefault(e => e.EntityTypeId != 7), "Non-purchase entity type in result set");
        }
        ...
        public void FilterOnEntityTypeSalePayment()
        {
            ...
            Assert.NotNull(result.DataObject, "Error with response object");
            Assert.NotNull(result.DataObject.Entities, "Error with response object entity collection");
            Assert.IsNull(result.DataObject.Entities.SingleOrDefault(e => e.EntityTypeId != 5), "Non-salepayment entity type in result set");
        }
        ...
        public void FilterOnEntityTypePurchasePayment()
        {
            ...
            Assert.NotNull(result.DataObject, "Error with response object");
            Assert.NotNull(result.DataObject.Entities, "Error with response object entity collection");
            Assert.IsNull(result.DataObject.Entities.SingleOrDefault(e => e.EntityTypeId != 8), "Non-salepayment entity type in result set");
        }
        ...
        public void FilterOnEntityTypeContact()
        {
            ...
            Assert.NotNull(result.DataObject, "Error with response object");
            Assert.NotNull(result.DataObject.Entities, "Error with response object entity collection");
            Assert.IsNull(result.DataObject.Entities.SingleOrDefault(e => e.EntityTypeId != 10), "Non-contact entity type in result set");
        }

        [Test]
        public void FilterOnEntityTypeInventoryItem()
        {
            var result = new DeletedEntitiesProxy().GetDeletedEntities(entityType: "inventoryitem");
            Assert.NotNull(result.DataObject, "Error with response object");
            Assert.NotNull(result.DataObject.Entities, "Error with response object entity collection");
            Assert.IsNull(result.DataObject.Entities.SingleOrDefault(e => e.EntityTypeId != 20), "Non-item entity type in result set");
        }
        ...
        public void FilterOnEntityTypeJournal()
        {
            ...
            Assert.NotNull(result.DataObject, "Error with response object");
            Assert.NotNull(result.DataObject.Entities, "Error with response object entity collection");
            Assert.IsNull(result.DataObject.Entities.SingleOrDefault(e => e.EntityTypeId != 26), "Non-journal entity type in result set");
        }
